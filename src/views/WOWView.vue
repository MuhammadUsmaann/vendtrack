  ...
  <div class=" report-generator bg-white px-3 py-4">
    <div class="row mx-0 align-item-center mb-1">
      ...
      <div class="col px-0 text-right">
        <span class="font-500 font-14 font-mono mr-1 w-md-100 d-inline-block mb-md-0 mb-2">Last Update: 02/18/2022</span>
        <b-dropdown id="dropdown-1" text="All Sales" variant="outline"
          class=" mt-2 d-inline-block inner-border-light-gray ml-md-2 inner-font-14 font-weight-500 font-black shadow-sm bg-transparent">
          <b-dropdown-item>First Action</b-dropdown-item>
          <b-dropdown-item>Second Action</b-dropdown-item>
          <b-dropdown-item>Third Action</b-dropdown-item>
        </b-dropdown>
        <b-dropdown id="dropdown-1" text="Cases" variant="outline"
          class=" mt-2 d-inline-block inner-border-light-gray ml-2 inner-font-14 font-weight-500 font-black shadow-sm bg-transparent">
          <b-dropdown-item>First Action</b-dropdown-item>
          <b-dropdown-item>Second Action</b-dropdown-item>
          <b-dropdown-item>Third Action</b-dropdown-item>
        </b-dropdown>
        <button class=" mt-2 btn border border-light-gray ml-2 font-14 font-weight-500 font-black shadow-sm"><img
            src="../assets/excel.png" alt="" class="pr-1"> <div class="d-md-inline-block d-none"> Export in Excel</div></button>
        <button class=" mt-2 btn border border-light-gray ml-2 font-14 font-weight-500 font-black shadow-sm"><img
...
export default {
  ...
  data: () => ({
    headers: [
      ...
      { text: 'YTD CS', value: 'YTDCS', },
      { text: 'PYTD CS', value: 'PYTDCS', },
      { text: 'CHG CS', value: 'CHGCS', },
      { text: '% CHG', value: 'CHG%', },
    ],
    reports: [],
    wowseries: [{
      name: "2022",
      data: [100000, 255000, 300000, 105600, 298000, 100000, 230000, 240000, 108800, 277800, 320000, 200000]
    },
    {
      name: "2021",
      data: [180000, 206760, 300000, 105600, 298000, 265500, 234000, 240870, 108970, 274300, 320124, 212300]

    },
    {
      name: '2020',
      data: [123456, 298769, 312345, 234513, 297650, 198660, 265700, 267600, 125480, 277800, 234400, 323000]
